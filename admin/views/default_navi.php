          ...
          <ul class="nav navbar-nav navbar-left">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="?page=new_post">Kirjoita uusi</a></li>
                <li><a href="?page=posts">Kaikki artikkelit</a></li> 
              </ul>
            </li>
            <li><a href="?page=users"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Käyttäjät</a></li>            
          </ul>
          <ul class="nav navbar-nav navbar-right">
          	<li><a href="?page=user"><strong><?php echo $_SESSION['user_name'] ?></strong></a></li>
